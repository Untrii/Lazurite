<template>
  ...
  <!-- <svg :width="width * scale" :height="height * scale">
    <ellipse :cx="halfWifth" :cy="halfHeight" :rx="halfWifth" :ry="halfHeight" :fill="fillColor" />
  </svg> -->
</template>
...
export default class extends Vue {
  ...
  get svgStyle() {
    ...
    return {
      transform: `scaleX(${this.width / this.height})`,
      marginLeft: `${-(scaledHeight - scaledWidth) / 2}px`,
    }
  }
}
</script>
